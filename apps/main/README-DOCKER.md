...
- `STREAM_ENDPOINT` - Create meditation API endpoint (default: "https://pod402.3vl.ca/api/create-meditation")
- `DEMO_ENDPOINT` - Demo meditation API endpoint (default: "https://pod402.3vl.ca/api/meditation/demo")
...
# API Endpoints
STREAM_ENDPOINT=https://pod402.3vl.ca/api/create-meditation
DEMO_ENDPOINT=https://pod402.3vl.ca/api/meditation/demo
```
